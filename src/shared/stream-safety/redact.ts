...
export function capForModel(input: string, maxChars = MODEL_OUTPUT_CAP): CappedResult {
...
export function sanitizeToolOutput(
  input: string,
  options: { cap?: boolean; maxChars?: number } = {},
): SanitizedToolOutput {
...
function detectSuspiciousFields(text: string): string[] {

...
export function createPromptCacheAffinity(sessionId: string): string | undefined {
...
export function createDesktopPromptCacheAffinity(
  sessionId: string,
  invocationId: string,
): string | undefined {
  if (
    !DESKTOP_SESSION_ID.test(sessionId)

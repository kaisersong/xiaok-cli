...
export const CHILD_COMMUNICATION_TOOL_NAMES = new Set<string>([
  'send_message',
  'wait_agent',
  'list_agents',
]);
...
export function createMultiAgentTools(options: CreateMultiAgentToolsOptions): Tool[] {
  return [
...
function createSpawnAgentTool(options: CreateMultiAgentToolsOptions): Tool {
  ...
  return {
    ...
    async execute(input, context) {
      const invocation = input as unknown as SpawnInvocation;
...
function createSendMessageTool(options: CreateMultiAgentToolsOptions): Tool {
...
function createFollowupTaskTool(options: CreateMultiAgentToolsOptions): Tool {
  return simpleMutationTool({
    name: 'followup_task',
...
function createWaitAgentTool(options: CreateMultiAgentToolsOptions): Tool {
  return {
    permission: 'safe',
    definition: {
      name: 'wait_agent',
...
function createListAgentsTool(options: CreateMultiAgentToolsOptions): Tool {
  return {
    permission: 'safe',
    definition: {
      name: 'list_agents',
...
function createInterruptAgentTool(options: CreateMultiAgentToolsOptions): Tool {
  return simpleMutationTool({
...
function createCloseAgentTool(options: CreateMultiAgentToolsOptions): Tool {
  return simpleMutationTool({
    name: 'close_agent',
...
function resolveCollaborativeAgentDef(
  agents: CustomAgentDef[],

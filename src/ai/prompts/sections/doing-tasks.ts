...
export function getDoingTasksSection(): string {
  return [
    ...
    "**Immediate execution**: When given a direct task request (e.g., '安装技能', 'fix this bug', 'create this file'), execute immediately. Do not discuss the plan first. Do not say 'I will help you' or 'Let me'. Just call the tools and do it.",

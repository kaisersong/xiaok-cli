...
import type { IntentBoundaryInput, RuleBoundaryDecision } from './boundary-types.js';
...
export function classifyIntentBoundaryByRules(input: IntentBoundaryInput): RuleBoundaryDecision {
...
function splitDeliverables(value: string): string[] {

...
- **Release Validation**: 355 CLI test files (2875 tests) and 215 Desktop test files (1786 tests) pass with **zero** failures, including the five pre-existing failures the previous release had to disclose. CLI typecheck, Desktop typecheck, `build:main`, and `build:renderer` are clean. Every new suite was proven red before its fix.

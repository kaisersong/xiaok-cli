...
describe('permissions/settings', () => {
  ...
  it('loadSettings reads global settings', async () => {
    ...
    await writeFile(join(globalDir, 'settings.json'), JSON.stringify(globalSettings));
  ...
  it('loadSettings reads project settings', async () => {
    ...
    await writeFile(join(projectDir, '.xiaok', 'settings.json'), JSON.stringify(projectSettings));

...
contextBridge.exposeInMainWorld('xiaokDesktop', {
  ...
  getCollaborationRoomWorkspace: (input) => ipcRenderer.invoke('desktop:roomWorkspace:get', input),
  previewCollaborationRoomWorkspace: (input) => ipcRenderer.invoke('desktop:roomWorkspace:preview', input),
  commitCollaborationRoomWorkspace: (input) => ipcRenderer.invoke('desktop:roomWorkspace:commit', input),
  cancelCollaborationRoomWorkspaceChange: (input) => ipcRenderer.invoke('desktop:roomWorkspace:cancelChange', input),
  listCollaborationRoomWorkspaceFiles: (input) => ipcRenderer.invoke('desktop:roomWorkspace:listFiles', input),
  previewCollaborationRoomWorkspaceFile: (input) => ipcRenderer.invoke('desktop:roomWorkspace:previewFile', input),
  publishCollaborationRoomWorkspaceInstructions: (input) => ipcRenderer.invoke('desktop:roomWorkspace:publishInstructions', input),

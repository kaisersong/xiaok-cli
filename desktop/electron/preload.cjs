...
contextBridge.exposeInMainWorld('xiaokDesktop', {
  ...
  openLocalPath: (filePath) => ipcRenderer.invoke('desktop:openLocalPath', { filePath }),
  readLocalArtifactPreview: (filePath) => ipcRenderer.invoke('desktop:readLocalArtifactPreview', { filePath }),
  ...
  updateUserLoopTemplate: (input) => ipcRenderer.invoke('desktop:loops:updateUserTemplate', input),
  deleteUserLoopTemplate: (loopId) => ipcRenderer.invoke('desktop:loops:deleteUserTemplate', loopId),
  setUserLoopAutoRunApproved: (loopId, approved) => ipcRenderer.invoke('desktop:loops:setUserTemplateAutoRunApproved', { loopId, approved }),

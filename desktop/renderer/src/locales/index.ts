...
export interface LocaleStrings {
  ...
  collaborationRoomLoading: string;
  collaborationRoomError: string;
  collaborationRoomDegraded: string;
  ...
  collaborationRoomProjectMembers: string;
  ...
  collaborationRoomBackToList: string;
  ...
  desktopSettings: {
    ...
    meetingAsrSettingsTitle: string;
    meetingAsrSettingsDesc: string;
    meetingRecordingSettingsTitle: string;
    meetingRecordingSettingsDesc: string;
    meetingRecordingLocalModelsTitle: string;
    meetingRecordingOnlineProvidersTitle: string;
    meetingAsrDefaultProvider: string;
    meetingAsrVolcengineTitle: string;
    meetingAsrAliyunTitle: string;
    meetingAsrConfigured: string;
    meetingAsrNotConfigured: string;
    meetingAsrAppKey: string;
    meetingAsrAccessKey: string;
    meetingAsrAccessToken: string;
    meetingAsrApiKey: string;
    meetingAsrBaseUrl: string;
    meetingAsrModel: string;
    meetingAsrEndpoint: string;
    meetingAsrResourceId: string;
    meetingAsrSave: string;
    meetingAsrSaving: string;
    meetingAsrSaved: string;
    runsHistory: string;
  ...
  projectsKnowledgeTab: string;
  projectsRulesTab: string;
  projectsKnowledgeBuiltin: string;
  projectsKnowledgeDefault: string;
  ...
  projectsRulesBuiltin: string;
  projectsRulesMine: string;
  projectsRulesWorkspace: string;
  projectsKnowledgeAdd: string;
  projectsRuleAdd: string;
  projectsKnowledgeCreateTab: string;
  projectsRuleCreateTab: string;
  projectsKnowledgeDocumentLabel: string;
  projectsRuleItemLabel: string;
  projectsKnowledgeUpload: string;
  projectsRuleContentPlaceholder: string;
  projectsRuleContentTooLong: string;
  projectsRuleSeverity: string;
  projectsRuleSeverityHard: string;
  projectsRuleSeveritySoft: string;
  projectsKnowledgeView: string;
  projectsKnowledgeClose: string;
  projectsKnowledgeExtractRules: string;
  projectsKnowledgeExtracting: string;
  projectsKnowledgeExtractedRules: string;
  projectsKnowledgeSaveRules: string;
  projectsKnowledgeRulesSaved: string;
  projectsKnowledgeExtractEmpty: string;
  projectsKnowledgeExtractFailed: string;
  projectsKnowledgeSaveFailed: string;
  ...
  knowledge: {
    ...
    pasteText: string;
    addUrl: string;
    meetingImport: string;
    meetingImportTitle: string;
    meetingRecordQuickStart: string;
    meetingRecorderTitle: string;
    meetingDefaultTitle: string;
    meetingRecordingDefaultTitle: (timestamp: string) => string;
    meetingTitleLabel: string;
    meetingRecordingTitleLabel: string;
    meetingTitlePlaceholder: string;
    meetingAudioLabel: string;
    meetingPickAudio: string;
    meetingRecordStart: string;
    meetingRecordStop: string;
    meetingRecordPause: string;
    meetingRecordResume: string;
    meetingAudioLevelLabel: string;
    meetingLatestTranscriptTitle: string;
    meetingRecorderTranscriptTitle: string;
    meetingRecorderHighlightsTitle: string;
    meetingRecorderHighlightsEmpty: string;
    meetingRecorderMinimize: string;
    meetingRecorderExpand: string;
    meetingRecorderSummaryTab: string;
    meetingRecorderTranscriptTab: string;
    meetingRecorderEditSummary: string;
    meetingRecorderFinishEditing: string;
    meetingRecorderProcessingTitle: string;
    meetingRecorderProcessingHint: string;
    meetingRecorderCloseBlocked: string;
    meetingSettings: string;
    meetingControlPanelTitle: string;
    meetingLiveTranscriptTitle: string;
    meetingSummaryDraftTitle: string;
    meetingSummaryDraftLabel: string;
    meetingSummaryDraftPlaceholder: string;
    meetingSpeechEngineLabel: string;
    meetingSpeechEngineSherpaOnnxParaformer: string;
    meetingSpeechEngineWhisperFallback: string;
    meetingSpeechEngineVolcengineAsr: string;
    meetingSpeechEngineAliyunAsr: string;
    meetingSpeechEngineSherpaOnnxName: string;
    meetingSpeechEngineWhisperName: string;
    meetingSpeechModelOption: (engineName: string, modelId: string, sizeLabel?: string) => string;
    meetingSpeechModelSherpaOnnxParaformerSmall: string;
    meetingSpeechModelLabel: string;
    meetingLanguageLabel: string;
    meetingLanguageZh: string;
    meetingLanguageAuto: string;
    meetingLanguageEn: string;
    meetingScenarioLabel: string;
    meetingScenarioDiscussion: string;
    meetingScenarioMeeting: string;
    meetingScenarioSales: string;
    meetingModelDownloadStatusTitle: string;
    meetingSpeechModelsStatusTitle: string;
    meetingPunctuationModelsStatusTitle: string;
    meetingModelStatusLoading: string;
    meetingModelStatusDownloaded: string;
    meetingModelStatusNotDownloaded: string;
    meetingModelStatusIncomplete: string;
    meetingModelStatusCorrupt: string;
    meetingModelStatusDownloading: string;
    meetingModelStatusUnavailable: string;
    meetingModelStatusLocalSize: (localSize: string, expectedSize: string) => string;
    meetingModelStatusLoadFailed: (reason: string) => string;
    meetingModelDownload: string;
    meetingModelRedownload: string;
    meetingModelUninstall: string;
    meetingModelActionRunning: string;
    meetingModelDownloadAria: (fileName: string) => string;
    meetingModelRedownloadAria: (fileName: string) => string;
    meetingModelUninstallAria: (fileName: string) => string;
    meetingModelActionFailed: (reason: string) => string;
    meetingOnlineAsrConfigTitle: string;
    meetingOnlineAsrConfigured: (providerName: string) => string;
    meetingOnlineAsrNotConfigured: (providerName: string) => string;
    meetingOnlineAsrSaveFailed: (reason: string) => string;
    meetingRecording: string;
    meetingRecordingPaused: string;
    meetingRecordingReady: string;
    meetingRecordingSaving: string;
    meetingNoAudioSelected: string;
    meetingTranscriptLabel: string;
    meetingTranscriptPlaceholder: string;
    meetingTranscriptPreviewLabel: string;
    meetingTranscriptPreviewEmpty: string;
    meetingListening: string;
    meetingSave: string;
    meetingSaving: string;
    meetingPickFailed: string;
    meetingRecordUnavailable: string;
    meetingPermissionDenied: string;
    meetingRecordedAudioSaved: string;
    meetingTranscribing: string;
    meetingDraftReady: string;
    meetingRecordFailed: (reason: string) => string;
    meetingLiveTranscriptionFailed: (reason: string) => string;
    meetingProcessError: (reason: string) => string;
    meetingImportSaved: string;
    meetingImportError: (reason: string) => string;
    openSource: (title: string) => string;
    sourceContentTitle: string;
    sourceContentLoading: string;
    sourceContentEmpty: string;
    sourceOpenFailed: (reason: string) => string;
    close: string;
    orDragFiles: string;
  ...
  artifactWorkspace: {
    ...
    saveNote: string;
    selectCollection: string;
    annotationPrompt: (versionId: string) => string;
    referencePrompt: (versionId: string) => string;
    continuePrompt: (versionId: string) => string;

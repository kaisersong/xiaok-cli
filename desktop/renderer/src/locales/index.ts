...
export interface LocaleStrings {
  ...
  desktopSettings: {
    ...
    loopsSettings: {
      title: string;
      userLoopsTitle: string;
      userLoopCount: (count: number) => string;
      refreshUserLoops: string;
      newMarkdownLoop: string;
      titleLabel: string;
      loopTitleAriaLabel: string;
      outputFileLabel: string;
      outputDirectoryLabel: string;
      promptLabel: string;
      loopPromptAriaLabel: string;
      cancel: string;
      create: string;
      loading: string;
      empty: string;
      ...
      createError: string;
      runError: string;
      enableScheduleError: string;
      disableScheduleError: string;
      updateAutoRunError: string;
      runNow: string;
      disableSchedule: string;
      enableSchedule: string;
      approveAutoRun: string;
      revokeAutoRun: string;
      lastRun: string;
      schedule: string;
      scheduleEnabled: string;
      scheduleDisabled: string;
      autoRunApproved: string;
      ...
      openOutputDirectoryAria: (path: string) => string;
      previewOutputFileAria: (fileName: string) => string;
      outputDirectoryOpenFailed: string;
      outputFilePreviewFailed: string;
      outputFilePathMissing: string;
    };

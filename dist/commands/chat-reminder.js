import { formatReminderTime } from '../runtime/reminder/service.js';
...
export function buildChatReminderHelpLines() {
    return CHAT_REMINDER_SLASH_COMMANDS.map((command) => command.helpLine);
}
export async function executeReminderSlashCommand(trimmed, context) {
...
function parseReminderSlashCommand(trimmed) {
    if (trimmed === '/remind') {

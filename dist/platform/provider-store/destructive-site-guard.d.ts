...
import { type InstanceVerdict } from './provider-source-pin.js';
import type { ProcessIdentity } from './plugin-claim-lock.js';
export type DestructiveSite = 'stage_pre_clean' | 'stage_exception_cleanup' | 'dependency_runtime_pre_clean' | 'dependency_runtime_exception_cleanup' | 'installer_catch_cleanup' | 'pointer_switch_prune' | 'uninstall';
export declare const DESTRUCTIVE_SITES: readonly DestructiveSite[];
export declare class MissingLockCapabilityError extends Error {
...
export type DestructiveDecision = {
    ...
    kind: 'reuse_readonly';
    reason: 'digest_live_pinned_and_verified';
} | {
    kind: 'version_in_use';
...
export declare function authoriseDestructiveMutation(request: DestructiveRequest): DestructiveDecision;
/**
...
export declare function planUninstall(request: Omit<DestructiveRequest, 'site' | 'reVerifies' | 'force'>): UninstallPlan;

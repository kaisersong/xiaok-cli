import { A2UI_MIME_TYPE, A2UI_PROTOCOL_VERSION, SAFE_A2UI_CATALOG_ID, sanitizeA2UIIdPart, } from './protocol.js';
import { assertRenderUiInput, validateA2uiMessages } from './validator.js';
export function compileRenderUiToA2ui(input, context) {

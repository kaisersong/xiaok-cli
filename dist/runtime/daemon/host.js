...
export class XiaokDaemonHost {
    ...
    async executeControlRpc(message) {
    ...
    async executeServiceRpc(client, message) {
    ...
    emitServiceEvent(service, clientInstanceId, name, payload) {

...
export function parseReminderRequest(request, options) {
    ...
    if (tomorrowExact) {
        ...
        return {
            ok: true,
            content,
            scheduleAt: zonedDateTimeToUtc(timezone, tomorrow.year, tomorrow.month, tomorrow.day, hour, minute),
            timezone,
        };
    }
    ...
    if (tomorrowMorning) {
        ...
        return {
            ...
            scheduleAt: zonedDateTimeToUtc(timezone, tomorrow.year, tomorrow.month, tomorrow.day, Number(tomorrowMorning[1]), tomorrowMorning[2] ? Number(tomorrowMorning[2]) : 0),
            timezone,
        };
    }
    return {
...
function addDaysInTimeZone(timestamp, timezone, days) {

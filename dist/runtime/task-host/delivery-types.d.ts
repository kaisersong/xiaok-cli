...
export interface GuardFailure {
    code: 'delivery_timeout' | 'snapshot_read_failed' | 'snapshot_write_failed' | 'verifier_start_failed' | 'verifier_crashed' | 'verifier_protocol_error' | 'verifier_internal_error' | 'verifier_capacity' | 'validation_limit' | 'deliverables_incomplete' | 'artifact_evidence_failed' | 'app_shutdown' | 'recovery_unconfirmed' | 'settlement_unconfirmed';
    stage: DeliveryStage;
...
export interface HostDeliveryReport {
...
export interface HostDeliveryRecoveryAuthority {

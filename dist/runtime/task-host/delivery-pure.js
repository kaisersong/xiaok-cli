export function collectArtifactEvidence(snapshot) {
...
export function buildCompletionEvidenceContext(taskId, snapshot) {
    return {
...
export function evidenceForExpectation(expectation, evidence) {
...
export function shouldRequireArtifactEvidence(snapshot) {
...
export function hasClarificationResult(snapshot) {
...
export function isEmptyDelivery(snapshot) {
    const summary = snapshot.result?.summary?.trim() ?? '';

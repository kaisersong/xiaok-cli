...
export function projectRuntimeEventToDesktopEvent(input) {
    ...
    if (event.type === 'approval_resolved')
        return { type: 'question_resolved', questionId: event.approvalId };
...
function projectRuntimeEventToInternalEvents(event) {
...
function artifactSummariesFromReceipt(value, turnId) {

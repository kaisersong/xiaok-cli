export type Action = 'submit' | 'newline' | 'history-prev' | 'history-next' | 'cursor-left' | 'cursor-right' | 'cursor-home' | 'cursor-end' | 'word-left' | 'word-right' | 'delete-back' | 'delete-word-back' | 'delete-to-start' | 'delete-to-end' | 'yank' | 'undo' | 'redo' | 'paste-image' | 'search-history' | 'clear-screen' | 'toggle-transcript' | 'cancel' | 'eof' | 'escape' | 'tab' | 'shift-tab';

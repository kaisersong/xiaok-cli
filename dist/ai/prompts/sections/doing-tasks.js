...
export function getDoingTasksSection() {
    return [
        ...
        "**Momentum**: Complete each step of a task without pausing for unnecessary confirmations. Action is preferred over discussion when the path forward is clear.",

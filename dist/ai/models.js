...
import { buildOpenAIHarnessContext, resolveKimiHarnessFeatureFlags, } from './providers/model-harness-profile.js';
...
function isKimiCodingCompatibilityEndpoint(baseUrl) {
    if (!baseUrl)
        return false;
    try {
...
export function resolveOpenAICompatibilityHeaders(binding) {
...
export function buildOpenAIAdapterInit(binding, env = process.env) {
    const identity = {
